...
class Encoder(layers.Layer):
    def __init__(self, encoded_size, dropout_rate=0.0):
        super(Encoder, self).__init__(name='encoder')
        self.dense1 = tfkl.Dense(500, activation='relu')
        self.dropout1 = tfkl.Dropout(dropout_rate)
        self.dense2 = tfkl.Dense(500, activation='relu')
        self.dropout2 = tfkl.Dropout(dropout_rate)
        self.dense3 = tfkl.Dense(2000, activation='relu')
        self.dropout3 = tfkl.Dropout(dropout_rate)
...
class Decoder(layers.Layer):
    def __init__(self, input_shape, activation, dropout_rate=0.0):
